 ...
 * @property int $armor
 * @property int|null $holy_res
 * @property int|null $fire_res
 * @property int|null $nature_res
 * @property int|null $frost_res
 * @property int|null $shadow_res
 * @property int|null $arcane_res
 * @property int $delay
 ...
 * @property int|null $VerifiedBuild
 */
