...
--
-- Estructura de tabla para la tabla `dungeon_access_template`
--

CREATE TABLE `dungeon_access_template` (
  `id` tinyint UNSIGNED NOT NULL COMMENT 'The dungeon template ID',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Dungeon/raid access template and single requirements';

--
-- Truncar tablas antes de insertar `dungeon_access_template`
--

TRUNCATE TABLE `dungeon_access_template`;
--
-- Volcado de datos para la tabla `dungeon_access_template`
--
