...
--
-- Estructura de tabla para la tabla `pet_name_generation_locale`
--
...
--
-- Truncar tablas antes de insertar `pet_name_generation_locale`
--

TRUNCATE TABLE `pet_name_generation_locale`;
--
-- Volcado de datos para la tabla `pet_name_generation_locale`
--
