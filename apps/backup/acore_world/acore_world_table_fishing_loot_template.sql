...
--
-- Estructura de tabla para la tabla `fishing_loot_template`
--
...
--
-- Truncar tablas antes de insertar `fishing_loot_template`
--

TRUNCATE TABLE `fishing_loot_template`;
--
-- Volcado de datos para la tabla `fishing_loot_template`
--
