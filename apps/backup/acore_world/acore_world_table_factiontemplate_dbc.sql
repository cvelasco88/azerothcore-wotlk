...
--
-- Estructura de tabla para la tabla `factiontemplate_dbc`
--
...
--
-- Truncar tablas antes de insertar `factiontemplate_dbc`
--

TRUNCATE TABLE `factiontemplate_dbc`;
--
-- Volcado de datos para la tabla `factiontemplate_dbc`
--
