...
--
-- Estructura de tabla para la tabla `skill_fishing_base_level`
--
...
--
-- Truncar tablas antes de insertar `skill_fishing_base_level`
--

TRUNCATE TABLE `skill_fishing_base_level`;
--
-- Volcado de datos para la tabla `skill_fishing_base_level`
--
