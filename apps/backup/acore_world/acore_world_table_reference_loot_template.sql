...
--
-- Estructura de tabla para la tabla `reference_loot_template`
--
...
--
-- Truncar tablas antes de insertar `reference_loot_template`
--

TRUNCATE TABLE `reference_loot_template`;
--
-- Volcado de datos para la tabla `reference_loot_template`
--
