...
--
-- Estructura de tabla para la tabla `skinning_loot_template`
--
...
--
-- Truncar tablas antes de insertar `skinning_loot_template`
--

TRUNCATE TABLE `skinning_loot_template`;
--
-- Volcado de datos para la tabla `skinning_loot_template`
--
