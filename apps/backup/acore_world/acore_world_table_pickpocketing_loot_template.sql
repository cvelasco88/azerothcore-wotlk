...
--
-- Estructura de tabla para la tabla `pickpocketing_loot_template`
--
...
--
-- Truncar tablas antes de insertar `pickpocketing_loot_template`
--

TRUNCATE TABLE `pickpocketing_loot_template`;
--
-- Volcado de datos para la tabla `pickpocketing_loot_template`
--
