...
--
-- Estructura de tabla para la tabla `item_set_names`
--
...
--
-- Truncar tablas antes de insertar `item_set_names`
--

TRUNCATE TABLE `item_set_names`;
--
-- Volcado de datos para la tabla `item_set_names`
--
