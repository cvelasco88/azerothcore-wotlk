...
--
-- Estructura de tabla para la tabla `disenchant_loot_template`
--
...
--
-- Truncar tablas antes de insertar `disenchant_loot_template`
--

TRUNCATE TABLE `disenchant_loot_template`;
--
-- Volcado de datos para la tabla `disenchant_loot_template`
--
