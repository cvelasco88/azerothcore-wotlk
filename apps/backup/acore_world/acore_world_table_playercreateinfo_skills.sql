...
--
-- Estructura de tabla para la tabla `playercreateinfo_skills`
--
...
--
-- Truncar tablas antes de insertar `playercreateinfo_skills`
--

TRUNCATE TABLE `playercreateinfo_skills`;
--
-- Volcado de datos para la tabla `playercreateinfo_skills`
--
