...
--
-- Estructura de tabla para la tabla `spell_script_names`
--
...
--
-- Truncar tablas antes de insertar `spell_script_names`
--

TRUNCATE TABLE `spell_script_names`;
--
-- Volcado de datos para la tabla `spell_script_names`
--
