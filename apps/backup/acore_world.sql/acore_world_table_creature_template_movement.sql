...
--
-- Estructura de tabla para la tabla `creature_template_movement`
--
...
--
-- Truncar tablas antes de insertar `creature_template_movement`
--

TRUNCATE TABLE `creature_template_movement`;
--
-- Volcado de datos para la tabla `creature_template_movement`
--
