...
--
-- Estructura de tabla para la tabla `vehicle_template_accessory`
--
...
--
-- Truncar tablas antes de insertar `vehicle_template_accessory`
--

TRUNCATE TABLE `vehicle_template_accessory`;
--
-- Volcado de datos para la tabla `vehicle_template_accessory`
--
