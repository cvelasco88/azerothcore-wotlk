...
--
-- Estructura de tabla para la tabla `areatrigger_scripts`
--
...
--
-- Truncar tablas antes de insertar `areatrigger_scripts`
--

TRUNCATE TABLE `areatrigger_scripts`;
--
-- Volcado de datos para la tabla `areatrigger_scripts`
--
