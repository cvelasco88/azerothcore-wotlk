...
--
-- Estructura de tabla para la tabla `spell_linked_spell`
--
...
--
-- Truncar tablas antes de insertar `spell_linked_spell`
--

TRUNCATE TABLE `spell_linked_spell`;
--
-- Volcado de datos para la tabla `spell_linked_spell`
--
