...
--
-- Estructura de tabla para la tabla `pool_quest`
--
...
--
-- Truncar tablas antes de insertar `pool_quest`
--

TRUNCATE TABLE `pool_quest`;
--
-- Volcado de datos para la tabla `pool_quest`
--
