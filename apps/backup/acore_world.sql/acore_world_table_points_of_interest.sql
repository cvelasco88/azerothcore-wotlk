...
--
-- Estructura de tabla para la tabla `points_of_interest`
--
...
--
-- Truncar tablas antes de insertar `points_of_interest`
--

TRUNCATE TABLE `points_of_interest`;
--
-- Volcado de datos para la tabla `points_of_interest`
--
