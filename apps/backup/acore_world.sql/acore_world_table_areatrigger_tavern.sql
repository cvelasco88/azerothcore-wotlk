...
--
-- Estructura de tabla para la tabla `areatrigger_tavern`
--
...
--
-- Truncar tablas antes de insertar `areatrigger_tavern`
--

TRUNCATE TABLE `areatrigger_tavern`;
--
-- Volcado de datos para la tabla `areatrigger_tavern`
--
