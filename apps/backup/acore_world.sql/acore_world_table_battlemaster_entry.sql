...
--
-- Estructura de tabla para la tabla `battlemaster_entry`
--
...
--
-- Truncar tablas antes de insertar `battlemaster_entry`
--

TRUNCATE TABLE `battlemaster_entry`;
--
-- Volcado de datos para la tabla `battlemaster_entry`
--
