...
--
-- Estructura de tabla para la tabla `instance_encounters`
--
...
--
-- Truncar tablas antes de insertar `instance_encounters`
--

TRUNCATE TABLE `instance_encounters`;
--
-- Volcado de datos para la tabla `instance_encounters`
--
