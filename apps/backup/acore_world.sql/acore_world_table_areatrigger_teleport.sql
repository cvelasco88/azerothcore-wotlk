...
--
-- Estructura de tabla para la tabla `areatrigger_teleport`
--
...
--
-- Truncar tablas antes de insertar `areatrigger_teleport`
--

TRUNCATE TABLE `areatrigger_teleport`;
--
-- Volcado de datos para la tabla `areatrigger_teleport`
--
