...
--
-- Estructura de tabla para la tabla `game_event_gameobject_quest`
--
...
--
-- Truncar tablas antes de insertar `game_event_gameobject_quest`
--

TRUNCATE TABLE `game_event_gameobject_quest`;
--
-- Volcado de datos para la tabla `game_event_gameobject_quest`
--
