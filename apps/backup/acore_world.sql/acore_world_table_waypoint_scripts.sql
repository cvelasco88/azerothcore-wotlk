...
--
-- Estructura de tabla para la tabla `waypoint_scripts`
--
...
--
-- Truncar tablas antes de insertar `waypoint_scripts`
--

TRUNCATE TABLE `waypoint_scripts`;
--
-- Volcado de datos para la tabla `waypoint_scripts`
--
