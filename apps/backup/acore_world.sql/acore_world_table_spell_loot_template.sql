...
--
-- Estructura de tabla para la tabla `spell_loot_template`
--
...
--
-- Truncar tablas antes de insertar `spell_loot_template`
--

TRUNCATE TABLE `spell_loot_template`;
--
-- Volcado de datos para la tabla `spell_loot_template`
--
