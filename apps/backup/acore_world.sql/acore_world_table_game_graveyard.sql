...
--
-- Estructura de tabla para la tabla `game_graveyard`
--
...
--
-- Truncar tablas antes de insertar `game_graveyard`
--

TRUNCATE TABLE `game_graveyard`;
--
-- Volcado de datos para la tabla `game_graveyard`
--
