...
--
-- Estructura de tabla para la tabla `graveyard_zone`
--
...
--
-- Truncar tablas antes de insertar `graveyard_zone`
--

TRUNCATE TABLE `graveyard_zone`;
--
-- Volcado de datos para la tabla `graveyard_zone`
--
