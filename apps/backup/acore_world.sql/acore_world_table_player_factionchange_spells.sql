...
--
-- Estructura de tabla para la tabla `player_factionchange_spells`
--
...
--
-- Truncar tablas antes de insertar `player_factionchange_spells`
--

TRUNCATE TABLE `player_factionchange_spells`;
--
-- Volcado de datos para la tabla `player_factionchange_spells`
--
