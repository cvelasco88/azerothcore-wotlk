...
--
-- Estructura de tabla para la tabla `points_of_interest_locale`
--
...
--
-- Truncar tablas antes de insertar `points_of_interest_locale`
--

TRUNCATE TABLE `points_of_interest_locale`;
--
-- Volcado de datos para la tabla `points_of_interest_locale`
--
