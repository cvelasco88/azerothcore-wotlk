...
--
-- Estructura de tabla para la tabla `skill_perfect_item_template`
--
...
--
-- Truncar tablas antes de insertar `skill_perfect_item_template`
--

TRUNCATE TABLE `skill_perfect_item_template`;
--
-- Volcado de datos para la tabla `skill_perfect_item_template`
--
