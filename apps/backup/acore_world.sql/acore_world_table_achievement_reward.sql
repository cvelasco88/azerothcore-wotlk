...
--
-- Estructura de tabla para la tabla `achievement_reward`
--
...
--
-- Truncar tablas antes de insertar `achievement_reward`
--

TRUNCATE TABLE `achievement_reward`;
--
-- Volcado de datos para la tabla `achievement_reward`
--
